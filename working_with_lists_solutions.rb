...
# 10.times do |this_round|
#   puts this_round * this_round
# end
...
names = ["Neal", "Mike", "Jeff", "Raghu", "Shay"]
...
# Challenge- edit the code so it will work even if you add names onto the array
...
# # The first solution using .times
...
# total = subtotal * (1 + sales_tax[state])
...
#   # calculating your total
#   total = subtotal * (1 + tax_hash[state])
